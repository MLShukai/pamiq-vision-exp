...
class ExperimentTrainer(TorchTrainer, ABC):
    ...
    trainer_name: str = "experiment"
    """Name of the trainer used for Aim context logging."""

    @property
    def default_aim_context(self) -> AimObjectDict:
    ...
    def setup(self) -> None:
        ...
        if (aim_run := get_global_run()) is None:
            raise ValueError(
                "No global Aim run found. Please initialize Aim before training."
            )
